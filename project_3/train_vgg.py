...
def load_model():
    ...
    base_model = VGG16(include_top=False, weights='imagenet', input_tensor=None, input_shape=(IMG_H, IMG_W, NUM_CHANNELS), pooling=None, classes=NUM_CLASSES)
    ...
    model.compile(optimizers.SGD(lr=1e-4, momentum=.9), loss='categorical_crossentropy',metrics=['accuracy'])
